...
// Default artifacts: route tree generated by @tanstack/router-generator
// (official file-based generator); manifest generated by scripts/gen-mpa.mjs
// (our MPA extension). Both derive from src/routes/*. A different authoring
// frontend (e.g. the Next-style app dir) passes its own pair in — the router
// wiring below is identical either way.
import { routeTree as defaultRouteTree } from '../routeTree.gen.js';
import { manifest as defaultManifest } from '../routes.manifest.js';
