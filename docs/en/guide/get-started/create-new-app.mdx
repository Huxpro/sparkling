...
<<<<<<< HEAD:docs/en/guide/get-started/create-new-app.mdx
### Run native targets
=======
2) Run on any platform:
>>>>>>> 3fbe481 (feat: add web method bridge, CLI web support, docs, and create-app web option):docs/en/guide/get-started/create-new-app.md
